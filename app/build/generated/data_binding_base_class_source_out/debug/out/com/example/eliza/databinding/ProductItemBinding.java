...
public final class ProductItemBinding implements ViewBinding {
  ...
  private ProductItemBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView textViewProductName, @NonNull TextView textViewProductQuantity) {
  ...
  public static ProductItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewProductQuantity;
      TextView textViewProductQuantity = ViewBindings.findChildViewById(rootView, id);
      if (textViewProductQuantity == null) {
        break missingId;
      }

      return new ProductItemBinding((ConstraintLayout) rootView, textViewProductName,
